...
SECRET_KEY = os.environ.get(
    "SECRET_KEY",
    "django-insecure-4=+)n()^$k-bfp9gnqh0oh9i@0b5j2&c0qkjj5u+^l!^+n-g^!"
)
...
# ⚠️ Solo en producción deben ser True. En local pueden romper cookies/sesión.
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                "django.template.context_processors.debug",  # ✅ faltaba (recomendado)
